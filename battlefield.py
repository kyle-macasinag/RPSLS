...
Spock smashes Scissors, Scissors decapitates Lizard, Lizard eats Paper, Paper disproves Spock, Spock vaporizes Rock""")
    ...
    def the_game(self):
        self.choose_rounds()       
        while (self.player_1.score < self.rounds) and (self.player_2.score < self.rounds):
            print(f"The current score is: {self.player_1.score} to {self.player_2.score}")
        ...
        if self.player_1.score == self.rounds or self.player_2.score == self.rounds:
            self.display_winner()    
        

    def display_winner(self):
        if self.player_1.score == self.rounds:
            print("Player 1 wins!")
            print(f"Player 1 wins! The final score is {self.player_1.score} to {self.player_2.score}")
        elif self.player_2.score == self.rounds:
            print("Player 2 wins!")
            print(f"Player 2 wins! The final score is {self.player_2.score} to {self.player_1.score}")
